...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0x13a41a;
...
*/
const char     GENESIS_COINBASE_TX_HEX[]                     = "30a08accddc1ff1f00002101c61b21df1dd3e42a36bf7126a1e447af6a2341bb4ba546b5967ae94879c8995d";
static_assert(sizeof(GENESIS_COINBASE_TX_HEX)/sizeof(*GENESIS_COINBASE_TX_HEX) != 1, "GENESIS_COINBASE_TX_HEX must not be empty.");

/* This is the unix timestamp of the first "mined" block (technically block 2, not the genesis block)
   You can get this value by doing "print_block 2" in TurtleCoind. It is used to know what timestamp
   to import from when the block height cannot be found in the node or the node is offline. */
const uint64_t GENESIS_BLOCK_TIMESTAMP                       = 1550949122;
...
const char     CRYPTONOTE_NAME[]                             = "Starshipcoin";
...
const int      P2P_DEFAULT_PORT                              =  17815;
const int      RPC_DEFAULT_PORT                              =  17816;
...
const char     LATEST_VERSION_URL[]                          = "http://starshipcoin.com";
const std::string LICENSE_URL                                = "https://github.com/turtlecoin/turtlecoin/blob/master/LICENSE";
const static   boost::uuids::uuid CRYPTONOTE_NETWORK         =
{
    {  0xb5, 0x0c, 0x4a, 0x2c, 0xcf, 0x52, 0x57, 0x41, 0x65, 0xf9, 0xa1, 0xa4, 0xb6, 0xc1, 0x43, 0xe9  }
};

const char* const SEED_NODES[] = {
  "208.180.220.104:12715"
};
} // CryptoNote
